...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 08. Mai 2025 um 08:42
...
INSERT INTO `spiele` (`Spiele_ID`, `Titel`, `Beschreibung`, `Preis`, `Kategorie_ID`, `Veröffentlichungsdatum`) VALUES
...
--
ALTER TABLE `spiele`
  MODIFY `Spiele_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `bewertung`
  ...
  ADD CONSTRAINT `bewertung_ibfk_2` FOREIGN KEY (`Spiel_ID`) REFERENCES `spiele` (`Spiele_ID`);
